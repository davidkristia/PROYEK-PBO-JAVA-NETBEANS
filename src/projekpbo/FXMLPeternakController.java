 ...
 * @author DAVID
 */
public class FXMLPeternakController implements Initializable {
    ...
    private void handleActionLogout(ActionEvent event) throws IOException {
        ...
        if (result.get() == ButtonType.OK){
            ...
            stage.setTitle("Tomok Ajibata - Halaman Utama");
            // Tampilkan stage
            stage.show();
    ...
    private void handleActionBeranda(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FXMLPeternakController.fxml"));
            Parent root = loader.load();
            ...
            // Set scene baru ke stage
            stage.setScene(scene);
            stage.setTitle("Tomok Ajibata - Halaman Beranda");
            // Tampilkan stage
            stage.show();
    ...
    private void handleActionTugas(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("FXMLTugasPeternak.fxml"));
        Parent root = loader.load();
        ...
        // Set scene baru ke stage
        stage.setScene(scene);
        stage.setTitle("Tomok Ajibata - Halaman Tugas Peternak");
        // Tampilkan stage
        stage.show();
